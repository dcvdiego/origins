...
<div id="TopToolbar">
	<input type="button" class="buttons" onClick="" value="File">
	<input type="button" class="buttons" onClick="" value="Edit">
	<input type="button" class="buttons" onClick="" value="Idk">
	</div>
...
<a href="home.php" class="buttons" style="float: right; margin-top: 7.5px;" onclick="notSaved(home);">Home</a>
<a href="logout.php" class="buttons" style="float: right; margin-top: 7.5px;" onclick="notSaved(logout);">Logout</a>
</body>
</html>